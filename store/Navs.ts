...
interface Navs {
    container: Window | HTMLElement | null   /* This will be used to point to the MainContainer component from other components */
...
export const useNavs = defineStore('navs', {
    ...
    actions: {
        setScrollEvent() {
            ...
            this.container?.addEventListener('scroll', this.scrollEventHandler, false)
        ...
        removeScrollEvent() {
            this.container?.removeEventListener('scroll', this.scrollEventHandler, false)
        },
        setContainer(value) {
